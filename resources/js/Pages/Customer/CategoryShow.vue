    ...
    <CustomerLayout>
        <div class="relative">
            <div class="relative bg-gradient-to-b from-cyan-500 to-cyan-800 h-[60vh] sm:h-[65vh] md:h-[70vh] lg:h-[75vh] flex flex-col items-center justify-end text-white px-4 bg-cover bg-center rounded-b-3xl"
                ...
                <!-- Content -->
                <div class="relative z-10 px-4 sm:px-6 md:px-8 mb-16 sm:mb-20 lg:mb-24 text-center">
                    <!-- Title -->
                    ...
                    <!-- Breadcrumb -->
                    <nav aria-label="breadcrumb" class="flex justify-center text-gray-200">
                        <ol
                            class="flex items-center justify-center gap-1 sm:gap-2 px-2 py-1 sm:px-4 sm:py-2 text-sm sm:text-base md:text-lg">
                            <li class="opacity-80 hover:text-cyan-400 transition">
                                <a href="/" class="inline-flex">
                                    <Icon name="home" :class="'h-4 w-4 sm:h-5 sm:w-5 md:h-5 md:w-5 mt-0.5 mx-1'" />
                                    Home
                                </a>
                            </li>
                            <span class="text-gray-300 mx-1">/</span>
                            <li class="font-semibold hover:text-cyan-400 transition">
                                Categories
                            </li>
        ...
        <div class="py-16 px-6 max-w-full mx-5">
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-10">
                ...
                <aside class="lg:col-span-1">
                    ...
                    <div class="bg-white shadow rounded-xl p-6 sticky top-24 space-y-6">
                        <!-- Date Filter -->
                        <div>
                        ...
                        <button class="w-full bg-cyan-600 text-white py-2 rounded-lg hover:bg-cyan-700 transition">
                            Apply Filters
                        </button>
                    </div>
                </aside>
                            ...
                            <div
                                ...
                                <div class="relative h-64 overflow-hidden">
                                    ...
                                    <div class="absolute bottom-6 left-6 right-6 text-white">
                                        <p class="text-xs pb-1 uppercase tracking-[0.25em]">
                                            {{ event.event_type }}
                                        </p>
                                        <Link :href="route('event.show', event.id)" class="text-xl font-black leading-tight tracking-tight line-clamp-1 hover:text-teal-400">
                                            {{ event.title }}
                                        </Link>
                                ...
                                <div class="relative px-3 py-6 min-h-[96px]">
                                    <div class="rounded-3xl p-1 space-y-4 flex-1">
                    ...
                    <div class="mt-6 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div class="flex items-center mt-4 gap-x-2 sm:mt-0">
                            ...
                            <button
                                ...
                                }" :disabled="!events.prev_page_url" @click="
                                    events.prev_page_url &&
                            ...
                            <template v-for="link in events.links" :key="link.label">
                                <button v-if="Number(link.label)" @click="link.url && router.visit(link.url)"
                            ...
                            <button
                                ...
                                }" :disabled="!events.next_page_url" @click="
                                    events.next_page_url &&

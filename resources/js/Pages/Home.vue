...
<template>
    ...
    <CustomerLayout>
        ...
        <div class="relative">
            <div
                ...
                <video autoplay muted loop playsinline class="absolute inset-0 w-full h-full object-cover">
                    <source src="https://assets.mixkit.co/videos/48504/48504-720.mp4" type="video/mp4" />
                ...
                <div class="relative z-10 text-center px-4 sm:px-8">
                    <h1 ref="heroTitleRef" class="text-4xl md:text-6xl font-extrabold text-white drop-shadow-lg">
                        Discover Events Near You
                    </h1>
                    <p ref="heroSubtitleRef" class="text-lg md:text-xl text-gray-200 mt-4 font-light">
            ...
            <div className="px-4">
                <div className="relative w-full sm:absolute sm:-bottom-10 sm:left-0 mt-10 sm:mt-0">
                    <div className="bg-white border border-gray-300 shadow-xl rounded-2xl mx-auto max-w-full sm:max-w-4xl px-4 sm:px-6 md:px-8 py-6 sm:py-10"
                        :style="{
                            boxShadow:
                        ...
                        <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-2">
                            <input type="text" placeholder="Search for events..."
                                class="flex-1 px-4 py-2 rounded-lg border focus:ring-2 focus:ring-cyan-500 focus:outline-none" />
                            <button
                                class="px-6 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-700 transition inline-flex">
                                <Icon name="search" />
        ...
        <section class="py-16 mt-10 px-6 max-w-7xl mx-auto">
            <h2 class="text-3xl font-bold mb-6 text-cyan-700" :ref="registerSectionTitle">
                Popular Categories
            </h2>
            <hr />
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 py-10">
                <div v-for="category in categories" :key="category.id"
                    ...
                    <!-- expanding circle -->
                    <span
                        class="absolute top-10 z-0 h-20 w-20 rounded-full bg-cyan-500 transition-all duration-300 group-hover:scale-[10]"></span>
                    ...
                    <div class="relative z-10 mx-auto max-w-md">
                        ...
                        <span
                            ...
                            <component :is="getCategoryIcon(category.name)" class="w-10 h-10 text-white" />
                        </span>
                        ...
                        <div class="pt-5 text-base font-semibold leading-7">
                            <p>
                                <button @click="browseCategory(category.name)"
        ...
        <section class="pb-24 px-6 bg-white">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="flex items-end justify-between mb-10">
                    <div>
                        <h2 class="text-3xl font-bold mb-2 text-cyan-700" :ref="registerSectionTitle">
                            Recommended Events
                        </h2>
                        <p class="text-gray-500 text-lg" :ref="registerSectionTitle">
                            Discover trending and upcoming experiences curated for you.
                        </p>
                    </div>

                    <button
                        class="hidden md:inline-block px-5 py-2 rounded-full bg-cyan-600 text-white text-sm font-semibold hover:bg-cyan-700 transition">
                        View All
                    </button>
                </div>
                <hr />
                <!-- Cards -->
                <div class="grid md:grid-cols-4 gap-12 pt-10">
                    <div v-for="event in recommendedEvents" :key="event.id" class="group cursor-pointer">
                        <!-- Image -->
                        <div class="relative overflow-hidden rounded-2xl border">
                            ...
                            <!-- Date badge -->
                            <div
                                class="absolute bottom-4 left-4 bg-white px-4 py-2 rounded-full text-sm font-medium shadow-md">
                                {{ event.event_date }}
                            </div>
                        </div>
                        ...
                        <div class="mt-6 space-y-2">
                            <h3 class="text-xl text-cyan-700 group-hover:text-black transition line-clamp-1">
                                {{ event.title }}
                            </h3>
                            ...
                            <div class="flex justify-between">
                                <p class="text-cyan-700 font-semibold">
                                    ₹ {{ event.price ?? 499 }}
                                </p>

                                <p class="inline-flex text-xs items-center gap-2">
                                    <span class="w-2 h-2 rounded-full" :class="event.max_capacity
                                            ? 'bg-emerald-500'
                                            : 'bg-rose-500'
                                        "></span>
                                    {{
            ...
            <div class="grid md:grid-cols-3 gap-8 mt-10">
                <div v-for="event in events" :key="event.title"
                    ...
                    <div class="p-5">
                        ...
                        <button class="mt-4 w-full bg-cyan-600 text-white py-2 rounded-lg hover:bg-cyan-700 transition">
                            View Details
                        </button>
                    </div>
                </div>
        ...
        <section class="relative py-24 bg-gray-950 overflow-hidden">
            ...
            <div class="absolute -top-32 -left-32 w-[28rem] h-[28rem] bg-cyan-500/30 rounded-full blur-3xl"></div>
            <div class="absolute top-40 -right-40 w-[28rem] h-[28rem] bg-teal-500/30 rounded-full blur-3xl"></div>
            ...
            <div class="relative max-w-7xl mx-auto px-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-14 pt-10">
                    <div v-for="(step, index) in steps" :key="step.title"
                        ...
                        <div v-if="index !== steps.length - 1"
                            ...
                            <svg class="w-10 h-10 text-cyan-400 opacity-80 animate-bounce-x" fill="none"
                        ...
                        <div class="relative mb-8">
                            ...
                            <div
                                ...
                                <Icon :name="step.icon" class="w-12 h-12 text-cyan-400" />
                                <!-- <Icon :is="step.icon" class="w-12 h-12 text-cyan-400" /> -->
                            </div>
                        </div>

                        <!-- Step label -->
                        <span class="text-sm font-semibold text-cyan-400 tracking-widest mb-2">
                            STEP {{ index + 1 }}
                        </span>
                ...
                <div class="mt-32 text-center">
                    <button
                        ...
                        <span
                            class="absolute inset-0 rounded-full bg-gradient-to-r from-cyan-500 via-teal-500 to-cyan-600 blur-2xl opacity-50 animate-pulse"></span>
